...
<div class="container abc">
  <div class="row">
    <div class="col-sm-4">
      <h3>Description</h3>
      <p>This website help you to create a league of sport, you can manage all of things of any league. We will support you with nthusiastic...</p>
    ...
    <div class="col-sm-4">
      <h3>Technologies</h3>
      <p>This website create base on Spring MVC framework with programming language Java. It also use anothers technologies such as : Hiberniate, JPA, Maven,...</p>
