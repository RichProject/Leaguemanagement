      <div class="container">       
		  	...
		  	<thead>
					<tr>
						<th>
							<button type="button" class="btn btn-default btn-lg">Create new team</button>
						</th>
						<th>
							<div class="input-group">
								<input type="text" id="searchTeam" class="form-control" onkeyup="filterStadiumName()" placeholder="Search...">
